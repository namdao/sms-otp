...
public class RNLogivanMobileSmsOtpModule extends ReactContextBaseJavaModule implements  GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,LifecycleEventListener {

	private static final String TAG = "RNLogivanMobileSmsOtp";
  ...
  public RNLogivanMobileSmsOtpModule(ReactApplicationContext reactContext) {
    super(reactContext);
	...
	public void getHash(Promise promise) {
		try {
			...
			SignatureHelper helper = new SignatureHelper(this.reactContext);
